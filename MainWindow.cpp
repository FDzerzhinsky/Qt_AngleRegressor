...
{
    // Ïîêàçûâàåì äèàëîã êàäðèðîâàíèÿ
    ...
    if (cropDialog.exec() == QDialog::Accepted) {
        ...
        // 2. Âû÷èñëÿåì ìàñøòàáèðîâàíèå ÷òîáû èçîáðàæåíèå âïèñûâàëîñü â label
        ...
        // 3. Óñòàíàâëèâàåì ìàñøòàáèðîâàííîå èçîáðàæåíèå
    ...
    // Åñëè ïîëüçîâàòåëü îòìåíèë äèàëîã, èçîáðàæåíèå íå îòîáðàæàåòñÿ
}
